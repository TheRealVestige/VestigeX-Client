...
public final class EntityDef
{
    ...
    public static EntityDef forID(int i)
    {
		...
		if (i == myass) {
	        ...
	        entityDef.description = "Vestige-x Official Construction Seller!".getBytes();
	...
	entityDef.name = "Vestige Wrecker";
	...
	entityDef.standAnim = 66;
		...
		entityDef.itemActions[2] = "Milestone";
                entityDef.description = "Vestige-x Official MilestoneCape Seller".getBytes();
                }
	...
	entityDef.description = "Hack3r`s Pink Car LikeaBoss".getBytes();
        ...
        if(i == 2586) {
     		...
     		entityDef.name = "Vestige Protector";
